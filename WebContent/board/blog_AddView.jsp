						...
						<div class="row no-gutters">
							<div class="col-md-7">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form method="POST" action="BoardServlet.do?command=blog_Add" enctype="multipart/form-data" name="contactForm"
										class="contactForm">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="subject">아이디</label> <input
														type="text" class="form-control" name="id" value="${nowuser}"
														placeholder="Subject">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" >제목</label> <input
														type="text" class="form-control" name="title" id="quantity"
