      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="MemberServlet.do?command=main_view">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="blog.jsp">Blog <i class="fa fa-chevron-right"></i></a></span> <span>Blog Single <i class="fa fa-chevron-right"></i></span></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
          	<p>
              <img src="blogimages/${SingleB.picture }" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3">${SingleB.title }</h2>
            <p>${SingleB.content }</p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5"><!-- 회원이올려놓은사진있으면 대체하는거 좋을듯! -->
                <img src="images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
                <h3>작성자:${SingleB.id }</h3>
