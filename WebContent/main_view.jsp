...
<body>
<c:set var="nowuser" value="${sessionScope.nowuser}" scope="session"></c:set>
<div class="wrap">
			<div class="container">
				<div class="row">
					<div class="col-md-6 d-flex align-items-center">
						<p class="mb-0 phone pl-md-2">
							<a href="#" class="mr-2"><span class="fa fa-phone mr-1"></span> +82 1234 567</a> 
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="ShopingServlet.do?command=liquor_buyok">주문내역</a>
              </div>
            </li>
            <li class="nav-item dropdown">
		...
		<section class="ftco-section">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <h2>Tastefully Yours</h2>
				...
				<div class="row">
				<c:forEach var="Llist" items="${Llist }" begin="${pagemaker.nowPageStart }">
										...
										<div class="desc">
											<p class="meta-prod d-flex">
												<a href="#"
													...
													class="d-flex align-items-center justify-content-center"><span
													class="flaticon-heart"></span></a> <a href="ShopingServlet.do?command=liquor_single&title=${Llist.title}"
													class="d-flex align-items-center justify-content-center"><span
				...
				<div class="row justify-content-center">
					<div class="col-md-4">
						<a href="ShopingServlet.do?command=liquor_list" class="btn btn-primary d-block">View All Products <span class="fa fa-long-arrow-right"></span></a>
					</div>
				</div>
			</div>
		</section>
