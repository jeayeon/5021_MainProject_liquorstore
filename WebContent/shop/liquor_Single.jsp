...
<html>
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="MemberServlet.do?command=main_view">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="product.jsp">Products <i class="fa fa-chevron-right"></i></a></span> <span>Products Single <i class="fa fa-chevron-right"></i></span></p>
    ...
    <section class="ftco-section">
    	<div class="container">
    	  <form action="ShopingServlet.do?" method="post" name="frm">
    	  <input type="hidden" name = "title" value="${Single.title}">
    	  <input type="hidden" name = "price" value="${Single.price}">
    	  <input type="hidden" name = "nowuser" value="${nowuser}">
    	  <input type="hidden" name = "command" value="liquor_cartAdd">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/${Single.picture }" class="image-popup prod-img-bg"><img src="images/${Single.picture }" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p class="price"><span>${Single.price } 원</span></p>
    				<p>${Single.content}</p>
						<div class="row mt-4">
						<!-- 버튼으로 +-를누르면 인풋타입의 값이 바뀌게 짠 소스 자바슨크립트로 엮은듯 하다 -->
	          	...
	          	<div class="w-100"></div>
	          	<div class="col-md-12">
	          		<p style="color: #000;">남은재고: ${Single.quantity }</p>
	          	</div>
          	</div>
          	<p><input type="submit" class="btn btn-primary py-3 px-5 mr-2" value="Add to Cart"><input type="button" class="btn btn-primary py-3 px-5" value="Buy now" onclick="directnow()"></p>
    			</div>
    		</div>
    	  </form>
