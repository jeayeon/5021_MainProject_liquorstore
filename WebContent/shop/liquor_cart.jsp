...
<html>
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="MemberServlet.do?command=main_view">Home <i class="fa fa-chevron-right"></i></a></span> <span>Cart <i class="fa fa-chevron-right"></i></span></p>
    ...
    <section class="ftco-section">
       <form action="ShopingServlet.do" name="frm" id="frm" method="post">
    	<div class="container">
    		<div class="row">
						    ...
						    <tr class="alert" role="alert">
						    	<td>
						    		<label class="checkbox-wrap checkbox-primary">
										  <input type="checkbox" checked name="check" value="${bList.no }"> <!-- 체크박스 -->
										  <span class="checkmark"></span>
										</label>
						    	</td>
						    	<td>
						    		<div class="img" style="background-image: url(images/${bList.picture});"></div>
						    	</td>
						      <td>
						      	<div class="email">
						      		<span>${bList.title }</span> <!-- 물건 이름 -->
						      	</div>
						      </td>
						      <td>${bList.price }</td><!-- 물건의 금액 -->
						      <td class="quantity">
					        	<div class="input-group">
					        	${bList.quantity }
				          	</div>
				          </td>
				          <td>${bList.total}</td><!-- 토탈금액 -->
						      <td>
						      <input type="hidden" name="quantity" value="${bList.quantity }">
						   	  <input type="hidden" name="title" value="${bList.title}">
					 	      <input type="hidden" name="price" value="${bList.price}">
					     	  <input type="hidden" name="total" value="${bList.total}">
						      <input type="hidden" name="bListno" value="${bList.no }">
						      
						      	<button type="button" name="close" class="close" data-dismiss="alert"
						      	 onclick="location.href='ShopingServlet.do?command=liquor_cartDel&no=${bList.no}'"><!-- 삭제 -->
    		...
    		<!-- 수정버튼 및 주문버튼 -->
    			<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
    			    <p class="text-center"><input type="button" class="btn btn-primary py-3 px-4" name="test" value="수량변경" onclick="location.href='ShopingServlet.do?command=liquor_cartMod'"></p>
    				<input type="hidden" name="command" value="liquor_buyView">
    				<p class="text-center"><input type="submit" class="btn btn-primary py-3 px-4" value="Proceed to Checkout"></p>
    			</div>
    		</div>
    	</div>
    	</form>
