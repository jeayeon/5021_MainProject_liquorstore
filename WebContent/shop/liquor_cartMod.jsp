    	...
    	<div class="container">
						    ...
						    <tr class="alert" role="alert">
						      ...
						      <td class="quantity">
					        	<div class="input-group">
				             	<input type="text" name="quantity" class="quantity form-control input-number" value="${bList.quantity }" min="1" max="100">
				          	</div>
				          </td>
    		...
    		<!-- 수정버튼 및 주문버튼 -->
    			<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
    				<input type="hidden" name="command" value="liquor_Cartquantitymod">
    				<p class="text-center"><input type="submit" class="btn btn-primary py-3 px-4" value="수량 변경"></p>
    			</div>
    		</div>
    	</div>
    	</form>
