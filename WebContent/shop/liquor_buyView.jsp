...
<html>
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="MemberServlet.do?command=main_view">Home <i class="fa fa-chevron-right"></i></a></span> <span>Checkout <i class="fa fa-chevron-right"></i></span></p>
    ...
    <form action="ShopingServlet.do" method="post" >
    	<div class="container">
          ...
          <div class="col-xl-10 ftco-animate">
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
	                	<label for="streetaddress">상세주소 입력</label>
	                  <input type="text" class="form-control" name="addr"value="${userInfo.addr }" placeholder="도로명주소 입력">
	                </div>
		            </div>
		            <div class="col-md-6">
		            	<div class="form-group">
	                  <input type="text" class="form-control" placeholder="아파트 주소 입력">
	                </div>
		            </div>
		            <div class="w-100"></div>
		            <div class="w-100"></div>
	          	...
	          	<div class="col-md-6">
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<input type="hidden" name = "command" value="liquor_buyok">
